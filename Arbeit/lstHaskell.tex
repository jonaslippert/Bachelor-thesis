...
% keywords
morekeywords=[1]{
where, data, deriving, type, newtype, instance, do, case, if, else, let, in, of, then
},

% UpperCase
morekeywords=[2]{WhiteSpaceBefore, Arrow, String, Position, Show, Diagram, Split, Parser, Maybe, Functor, Just, Nothing, Applicative, Alternative, Char, SAD, Control, Data, List, Eq, Int, Bool, True},
...
{≥}{{\ensuremath{\geq}}}1
{≠}{{\ensuremath{\neq}}}1
{=}{{\color{symbolcolor}\ensuremath{=}}}2
{Psi}{{\ensuremath{\Psi}}}2
{<}{{\ensuremath{<}}}2
{>}{{\ensuremath{>}}}2
{≈}{{\ensuremath{\approx}}}1
{≡}{{\ensuremath{\equiv}}}1
